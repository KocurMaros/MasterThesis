...
\FEItitleEn{Operator Emotion Authentication Based on Facial Expression}
\FEIkeywords{RGB kamera, neurónová sieť}
\FEIkeywordsEn{RGB camera, neural network}
\FEIregNr{FEI-100863-111119}
\FEIsupervisor{prof. Ing. Jarmila Pavlovičová, PhD.}
\FEIconsultant{Ing. Michal Tölgyessy}
\FEIdate{25}{5}{2025} % Date of submission (Day, month, year)
